...
@router.path('/upload_picture', response_schema=PictureResponseSchema(), status_code=status.HTTP_201_CREATED)
...
@router.path('/{picture_id}', response_schema= PictureResponseSchema)
